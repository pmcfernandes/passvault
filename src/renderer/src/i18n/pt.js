export default {
  ...
  addModal: {
    ...
    defaultCategories: 'Predefinidas',
  ...
  settings: {
    ...
    exported: '{count} palavras-passe exportadas.',
    minChars: 'A palavra-passe deve ter pelo menos 8 caracteres.',
    importAccounts: 'Importar Palavras-passe',
    importDesc: 'Importar palavras-passe de um ficheiro de backup encriptado.',
    importButton: 'Importar ({count} novas)',
    ...
    enterPassword: 'Introduza primeiro a palavra-passe do backup.',
    importCancelled: 'Importação cancelada.',
    wrongPassword: 'Palavra-passe incorreta ou ficheiro de backup inválido.',
    previewSummary: '{newCount} entradas novas, {dupCount} duplicados serão ignorados.',
    imported: '{count} entradas importadas.',
    imports: 'Importações',
    edgeImport: 'Importar do Edge',
    edgeImportDesc: 'Importar palavras-passe de um ficheiro CSV exportado do Microsoft Edge.',
    selectCsvFile: 'Selecionar ficheiro CSV',
    csvPreview: '{newCount} entradas novas, {dupCount} duplicados serão ignorados.',
    csvImported: '{count} palavras-passe importadas do Edge.',
    language: 'Idioma',
